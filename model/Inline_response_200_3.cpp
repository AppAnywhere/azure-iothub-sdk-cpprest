...
std::vector<std::shared_ptr<Inline_response_200_3_value>>& Inline_response_200_3::getValue()
{
    return m_Value;
}
bool Inline_response_200_3::valueIsSet() const
{
    return m_ValueIsSet;
}
void Inline_response_200_3::unsetValue()
{
    m_ValueIsSet = false;
}
utility::string_t Inline_response_200_3::getNextLink() const
{
    return m_NextLink;
}
void Inline_response_200_3::setNextLink(utility::string_t value)
{
    m_NextLink = value;
    m_NextLinkIsSet = true;
}
bool Inline_response_200_3::nextLinkIsSet() const
{
    return m_NextLinkIsSet;
}
void Inline_response_200_3::unsetNextLink()
{
    m_NextLinkIsSet = false;
}
