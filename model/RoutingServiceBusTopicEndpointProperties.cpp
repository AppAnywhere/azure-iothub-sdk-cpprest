...
void RoutingServiceBusTopicEndpointProperties::validate()
{
...
utility::string_t RoutingServiceBusTopicEndpointProperties::getName() const
{
    return m_Name;
}
...
utility::string_t RoutingServiceBusTopicEndpointProperties::getSubscriptionId() const
{
...
bool RoutingServiceBusTopicEndpointProperties::subscriptionIdIsSet() const
{
...
bool RoutingServiceBusTopicEndpointProperties::resourceGroupIsSet() const
{
