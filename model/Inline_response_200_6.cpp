...
void Inline_response_200_6::fromJson(web::json::value& val)
{
    {
        m_Value.clear();
        std::vector<web::json::value> jsonArray;
...
std::vector<std::shared_ptr<Inline_response_200_6_value>>& Inline_response_200_6::getValue()
{
    return m_Value;
}
bool Inline_response_200_6::valueIsSet() const
{
    return m_ValueIsSet;
}
void Inline_response_200_6::unsetValue()
{
    m_ValueIsSet = false;
}
utility::string_t Inline_response_200_6::getNextLink() const
{
    return m_NextLink;
}
void Inline_response_200_6::setNextLink(utility::string_t value)
{
    m_NextLink = value;
    m_NextLinkIsSet = true;
}
bool Inline_response_200_6::nextLinkIsSet() const
{
    return m_NextLinkIsSet;
}
void Inline_response_200_6::unsetNextLink()
{
    m_NextLinkIsSet = false;
}
