...
/*
 * IotHubProperties_routing_endpoints.h
 *
 * The properties related to the custom endpoints to which your IoT hub routes messages based on the routing rules. A maximum of 10 custom endpoints are allowed across all endpoint types for paid hubs and only 1 custom endpoint is allowed across all endpoint types for free hubs.
 */

#ifndef IotHubProperties_routing_endpoints_H_
#define IotHubProperties_routing_endpoints_H_
...
/// The properties related to the custom endpoints to which your IoT hub routes messages based on the routing rules. A maximum of 10 custom endpoints are allowed across all endpoint types for paid hubs and only 1 custom endpoint is allowed across all endpoint types for free hubs.
/// </summary>
class  IotHubProperties_routing_endpoints
    : public ModelBase
{
public:
    IotHubProperties_routing_endpoints();
    virtual ~IotHubProperties_routing_endpoints();
    ...
    /////////////////////////////////////////////
    /// IotHubProperties_routing_endpoints members
...
#endif /* IotHubProperties_routing_endpoints_H_ */
