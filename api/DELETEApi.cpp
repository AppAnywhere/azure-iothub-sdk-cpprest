...
DELETEApi::DELETEApi( std::shared_ptr<ApiClient> apiClient )
...
boost::replace_all(path, U("{") U("resourceName") U("}"), ApiClient::parameterToString(resourceName));
    ...
    {
        throw ApiException(400, U("DELETEApi->iotHubResourceDelete does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, U("DELETEApi->iotHubResourceDelete does not consume any supported media type"));
    }
    ...
    .then([=](web::http::http_response response)
    {
        ...
        if (response.status_code() >= 400)
        {
            throw ApiException(response.status_code()
                , U("error calling iotHubResourceDelete: ") + response.reason_phrase()
        ...
        if(response.headers().has(U("Content-Type")))
        {
            ...
            if( contentType.find(responseHttpContentType) == std::string::npos )
            {
                throw ApiException(500
                    , U("error calling iotHubResourceDelete: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
...
boost::replace_all(path, U("{") U("name") U("}"), ApiClient::parameterToString(name));
    ...
    {
        throw ApiException(400, U("DELETEApi->iotHubResourceDeleteEventHubConsumerGroup does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, U("DELETEApi->iotHubResourceDeleteEventHubConsumerGroup does not consume any supported media type"));
    }
    ...
    .then([=](web::http::http_response response)
    {
        ...
        {
            throw ApiException(response.status_code()
                , U("error calling iotHubResourceDeleteEventHubConsumerGroup: ") + response.reason_phrase()
                , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
        }
        ...
        if(response.headers().has(U("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , U("error calling iotHubResourceDeleteEventHubConsumerGroup: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
